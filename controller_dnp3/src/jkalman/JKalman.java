...
*/      
    ...
    public Matrix Correct(final Matrix measurement) {
        ...
        Matrix temp4_var=error_cov_pre.times(measurement_matrix.transpose());
	Matrix ident = new Matrix(1,1,1);	
	temp4=temp4_var.times(temp3.solve(ident));	
        // temp4 = inv(temp3)*temp2 = Kt(k) 
        //temp4 = temp3.solve(temp2);
	//System.out.println("T4' :" +  error_cov_pre.times(measurement_matrix.transpose()));
	//System.out.println("T3^-1 :" + temp3.inverse());
	//System.out.println("T4 :" + temp4);
	//temp4=(error_cov_pre.times(measurement_matrix)).times(temp3.inverse());        
    ...
    /**
     * Residue.
     * The function <code>Residue</code> Update estimate with measurement z(k)</p>
     * <pre>
     * x<sub>k</sub>=x'<sub>k</sub>+K<sub>k</sub>*(z<sub>k</sub>-H*x'<sub>k</sub>)
     * where
     * z<sub>k</sub> - given measurement (<code>mesurement</code> parameter)
     * </pre>
     * <p>The function Update estimate with measurement z(k) at <code>residue</code> and 
     * returns it on output.
     * @param measurement Matrix containing the measurement vector.
     * @return
     */
    public Matrix getResidue() {
        ...
        // temp5 = z(k) - H*x'(k) 
    	//residue//temp5 = measurement_matrix.gemm(state_pre, measurement, -1, 1);   
        return temp5;
    }
